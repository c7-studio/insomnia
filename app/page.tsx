...
export default function Home() {
  ...
  return (
    <div className="h-screen w-full bg-black">
      ...
      <div className="flex justify-center items-center py-4 pt-7 flex-col">
        ...
        <p className="text-white text-left">Tambien DISPONIBLE en 
          <span className="hover:text-yellow">
            <Link href='https://insomnia111.bandcamp.com/track/insomnia'> Bandcamp</Link>
          </span>
        </p>
        <div className="">
